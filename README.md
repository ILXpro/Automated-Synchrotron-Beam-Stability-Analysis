...
Repository file structure:
  ...
  * `X-Beam_Stability_Analysis_2.py` — The primary image analysis script.
  * `X-Beam_Stability_Analysis_2_stage2.py` — The evolution analysis script.
  * `Data/` — A directory for raw images. Inside, you can have subdirectories like `Data/0.001s/` containing your raw images.
  * `Data/0.001s/analysis_output/` — This folder contains the output generated by the programs.